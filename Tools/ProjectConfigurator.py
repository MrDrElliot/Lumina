...
def create_project(folder, name):
    ...
    file_path = os.path.join(folder, name + ".lproject")
    ...
    try:
        ...
        print(f"{Fore.GREEN}Project JSON '{name}' created at {file_path}{Style.RESET_ALL}")
    except Exception as e:
        print(f"{Fore.RED}Error creating project JSON: {e}{Style.RESET_ALL}")
