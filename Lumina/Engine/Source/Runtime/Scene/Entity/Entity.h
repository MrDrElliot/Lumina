...
namespace Lumina
{
    ...
    public:
        ...
        Entity() = default;
        Entity(const entt::entity& InHandle, AScene* InScene);
        Entity(const entt::entity& InHandle, TSharedPtr<AScene> InScene);

        
        AScene* GetScene()                      { return mScene; }
